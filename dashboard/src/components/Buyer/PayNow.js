...
const PayNow = () => {
    ...
    return (
        <>
            <div className="bg-gradient2  align-items-center d-flex justify-content-center pt-2 pt-sm-5 pb-4 pb-sm-5">
                                    ...
                                    <div className="p-xl-5 p-3">
                                        ...
                                        <div className="authentication-form">
                                            ...
                                            >
                                                ...
                                                <input name="amount" value={order.packagePrice} />
                                                ...
                                                <input
                                                    ...
                                                    name="pay_now"
                                                    id="pay_now"
                                                    className="paypay--btn me-2 mb-2 mb-xxl-0 btn btn-outline-primary"
