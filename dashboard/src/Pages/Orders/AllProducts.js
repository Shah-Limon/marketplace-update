...
const AllProducts = () => {
    ...
    useEffect(() => {
        ...
        let filtered = products.filter(product =>
            ...
            product.sellerEmail.toLowerCase().includes(searchEmail.toLowerCase())
        );
        setFilteredUsers(filtered);
    }, [searchName, searchEmail, searchCategory, products]);
                                            ...
                                            <table class="table table-editable table-nowrap align-middle table-edits">
                                                ...
                                                <tbody>
                                                    {products === null ? (
                                                        ...
                                                        <tr key={e._id}>
                                                            <td data-field="name">{e.sellerEmail}</td>
                                                            <td data-field="name">{e.productName}</td>
