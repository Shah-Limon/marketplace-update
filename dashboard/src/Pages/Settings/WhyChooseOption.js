...
const WhyChooseOption = () => {
    ...
    const handleCreateWhyChoose = (event) => {
        ...
        fetch(url, {
            ...
            .then((result) => {
                ...
                fetch(`http://localhost:5000/why-choose`)
                    .then((res) => res.json())
                    .then((info) => setChoose(info.reverse()));
            })
            .catch((error) => {
                // Handle error
                        ...
                        <div className="container-fluid">
                                ...
                                <div class="my-4 text-center">
                                    <button type="button" class="btn btn-success waves-effect waves-light"
                                        data-bs-toggle="modal" data-bs-target=".bs-example-modal-center-addServices"><i
                                            class="mdi mdi-plus me-2"></i>Add Why Choose</button>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form className="comment-form" onSubmit={handleCreateWhyChoose}>
                                                    <div className="fadeInUp style-2 text-center">
                                                        <div className="main-title"><h3>Add Why Choose</h3></div>
                                                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Why Choose Option Lists</h4>
                                                                            ...
                                                                            <div className="modal-content">
                                                                                ...
                                                                                <div className="modal-body">
                                                                                    <form className="comment-form" onSubmit={(event) => handleEditHelp(event, e._id)}>
                                                                                        <div className="fadeInUp style-2 text-center">
                                                                                            <div className="main-title"><h3>Edit Why Choose</h3></div>
                                                                                        </div>
                                                                                        <div className="columns  gap20">
                                                                                            <fieldset className="name ">
                                                                                                <label>Enter Image URL</label>
