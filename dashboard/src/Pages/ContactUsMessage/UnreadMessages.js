...
const UnreadMessages = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/contact-messages?status=UnRead`)
            .then((res) => res.json())
    ...
    const handleMarkAsRead = (id) => {
        ...
        fetch(url, {
            ...
            body: JSON.stringify({ messageStatus: "Read" }),
        })
            .then((res) => res.json())
            .then((result) => {
                fetch(`http://localhost:5000/contact-messages?status=UnRead`)
                ...
                <div className="col-12">
                    <div className="card">
                        <div className="card-body">
                            <h4 className="card-title">Un Read Messages</h4>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-primary" onClick={() => handleMarkAsRead(selectedMessage._id)}>Mark Read<i className="fab fa-telegram-plane ms-1"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
